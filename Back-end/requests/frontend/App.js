...
function App() {
  ...
  const addCredit = async (event) => {
    ...
    const url = '/api/student/addCredit';
  ...
  const getSubscriptionEndDate = async (event) => {
    ...
    const url = '/api/student/getSubscriptionEndDate';
  ...
  const getCourses = async (event) => {
    ...
    const url = '/api/student/getCourses';
  ...
  const buyPlace = async (event) => {
    ...
    const url = '/api/student/buyPlace';
  ...
  const getPaymentsHistory = async (event) => {
    ...
    const url = '/api/student/getPaymentHistory';
    ...
    try {
      ...
      const result = await response.json();
      setPaymentsHistory(result.payments);
    } catch (error) {
      console.error("Erreur :", error);
    }
  };
  ...
  const resetPassword = async (event) => {
    ...
    const url = '/api/user/generateResetToken';
  ...
  const searchParticipatedCourses = async (event) => {
    ...
    const url = '/api/student/searchParticipatedCourses';
  ...
  const getStudent = async (event) => {
    ...
    const url = '/api/teacher/getStudent';
  ...
  const newStudent = async (event) => {
    ...
    const url = '/api/teacher/newStudent';
  ...
  const modifyStudent = async (event) => {
    ...
    const url = '/api/teacher/modifyStudent';
  ...
  const removeStudent = async (event) => {
    ...
    const url = '/api/teacher/removeStudent';
  ...
  const cancelCourse = async (event) => {
    ...
    const url = '/api/teacher/cancelCourse';
          ...
          <ul>
            {studentCourses.map(course => (
              <li key={course.courseID}>
                {course.title} {course.type} - {formatDate(course.startDate)}
              </li>
            ))}
          </ul>
        </div>
